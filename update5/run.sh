...
ml_v3_push=`grep PUSH miller_loop_v3.trace | grep -v PUSH16 | wc -l`
ml_v3_mem=`grep -E "MSTORE|MLOAD" miller_loop_v3.trace | wc -l`
ml_v3_dup=`grep DUP miller_loop_v3.trace | wc -l`
...
ml_v4_push=`grep PUSH miller_loop_v4.trace | grep -v PUSH16 | wc -l`
ml_v4_mem=`grep -E "MSTORE|MLOAD" miller_loop_v4.trace | wc -l`
ml_v4_dup=`grep DUP miller_loop_v4.trace | wc -l`
ml_v4_others=`grep -vE "PUSH16|MSTORE|MLOAD|384" miller_loop_v4.trace | wc -l`

echo "Paste to figure1.plt:"
echo "v7\\\_f2mul\\\_v3 $ml_v3_addmod384 $ml_v3_submod384 $ml_v3_mulmod384 $ml_v3_push16 $ml_v3_push $ml_v3_dup $ml_v3_mem $ml_v3_others"
echo "v7\\\_f2mul\\\_v4 $ml_v4_addmod384 $ml_v4_submod384 $ml_v4_mulmod384 $ml_v4_push16 $ml_v4_push $ml_v4_dup $ml_v4_mem $ml_v4_others"
echo "v9\\\_f2mul\\\_v3 $ml_v3_addmod384 $ml_v3_submod384 $ml_v3_mulmod384 0 $ml_v3_push $ml_v3_dup $ml_v3_mem $ml_v3_others"
echo "v9\\\_f2mul\\\_v4 $ml_v4_addmod384 $ml_v4_submod384 $ml_v4_mulmod384 0 $ml_v3_push $ml_v3_dup $ml_v4_mem $ml_v4_others"
...
echo "Paste to figure1_v3_vs_v4.plt:"
echo "miller\\\_loop\\\_f2mul\\\_v3 $ml_v3_addmod384 $ml_v3_submod384 $ml_v3_mulmod384"
echo "miller\\\_loop\\\_f2mul\\\_v4 $ml_v4_addmod384 $ml_v4_submod384 $ml_v4_mulmod384"
echo "final\\\_exp\\\_f2mul\\\_v3 $fe_v3_addmod384 $fe_v3_submod384 $fe_v3_mulmod384"
echo "final\\\_exp\\\_f2mul\\\_v4 $fe_v4_addmod384 $fe_v4_submod384 $fe_v4_mulmod384"
